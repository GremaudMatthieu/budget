export default {
  ...
  auth: {
    ...
    welcomeSubtitle: '50/30/20 Budget and Envelope Method to Partition Your Savings',
    ...
    whyChooseTitle: 'Our Features',
    whyChooseDescription: 'GoGoBudgeto generates your monthly budget plans according to the 50/30/20 rule and uses envelopes to organize your savings by category. Free and without bank connection.',
    howItWorksTitle: 'The 50/30/20 Rule with GoGoBudgeto',
    howItWorksDescription: 'GoGoBudgeto automatically generates your budget plans according to the 50/30/20 method: the proven solution to optimize your personal finances and save up to 20% of your income.',
    budgetingBenefits: 'Intelligently distribute your income with the 50/30/20 rule applied by GoGoBudgeto. Needs (50%), Wants (30%), Savings (20%).',
    secureAndPrivate: 'Secure & Private',
    features: 'Our Features',
    smartBudgetingTitle: '50/30/20 Budget Plans',
    smartBudgetingDescription: 'Easily create your monthly budget plans according to the 50/30/20 rule and adjust them based on your actual expenses.',
    budgetPlanningTitle: 'Savings Envelopes',
    budgetPlanningDescription: 'Organize your 20% savings by creating envelopes for each goal: vacation, emergency, projects.',
    smartInsightsTitle: 'Partition Your Savings',
    smartInsightsDescription: 'Envelopes allow you to divide your savings into specific goals and track your progress.',
    saveUpTo: 'Save up to 20%',
    ofMonthlyExpenses: 'of your income with our advanced budgeting techniques',
