...
final class UserEmailRegisteredDomainEvent_v1 implements UserDomainEventInterface, VersionedDomainEventInterface
{
    use VersionedEventTrait;

    public const int VERSION = 1;
    public const string EVENT_TYPE = 'UserEmailRegistered';
